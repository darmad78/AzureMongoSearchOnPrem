...
echo "   3. Copy environment file: cp other_deployments/option2-docker-compose/env.ubuntu.example .env (if using Docker Compose)"
echo "   4. Run phase deployment scripts:"
