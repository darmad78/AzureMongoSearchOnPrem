...
# Get external IP dynamically (frontend will construct API URL from current hostname at runtime)
EXTERNAL_IP=$(curl -s ifconfig.me 2>/dev/null || curl -s icanhazip.com 2>/dev/null || echo "${VM_IP}")
